  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 space-y-6">
        ...
        <AlertBanner type="warning" title="Hồ sơ vay cần bổ sung tài liệu" message="Vietcombank yêu cầu bổ sung sao kê tài khoản 6 tháng gần nhất. Hạn nộp: 10/05/2026." />

...
import type { TaiSan } from '@/src/lib/types'
...
export default function ChuSoHuuDashboard() {
  ...
  const giaoDichChoKy = mockTaiSan.filter(t => t.trang_thai === 'dang_giao_dich').length
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 space-y-6">
        ...
        <AlertBanner type="info" title="Cần ký hợp đồng" message="Căn hộ Vinhomes Grand Park đang chờ bạn ký hợp đồng chuyển nhượng. Liên hệ đối tác Nguyễn Minh Tuấn." />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <MetricCard title="Đang giao dịch" value={`${giaoDichChoKy} BĐS`} sub="Cần hành động" icon="⏳" color="yellow" />
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                ...
                <tbody className="divide-y divide-gray-100">
                  {mockTaiSan.map((ts) => {
                    const st = trangThaiMap[ts.trang_thai]
                    return (

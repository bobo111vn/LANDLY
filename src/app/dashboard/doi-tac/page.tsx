...
const mockGiaoDich: GiaoDich[] = [
  {
    id: 'GD001', tai_san_id: 'TS001', ten_tai_san: 'Căn hộ Vinhomes Grand Park Q9',
    nguoi_ban_id: 'U01', ten_nguoi_ban: 'Trần Văn An',
    nguoi_mua_id: 'U02', ten_nguoi_mua: 'Lê Thị Bình',
    doi_tac_id: 'U03', ten_doi_tac: 'Nguyễn Minh Tuấn',
    gia_giao_dich: 3200000000, ngay_tao: '2026-04-01', ngay_cap_nhat: '2026-04-28',
    trang_thai: 'cho_ky_hop_dong',
  },
  {
    id: 'GD002', tai_san_id: 'TS002', ten_tai_san: 'Nhà phố Bình Thạnh 85m²',
    nguoi_ban_id: 'U04', ten_nguoi_ban: 'Phạm Quốc Hùng',
    nguoi_mua_id: 'U05', ten_nguoi_mua: 'Hoàng Lan Anh',
    doi_tac_id: 'U03', ten_doi_tac: 'Nguyễn Minh Tuấn',
    gia_giao_dich: 6800000000, ngay_tao: '2026-03-15', ngay_cap_nhat: '2026-04-30',
    trang_thai: 'dam_phan',
  },
  {
    id: 'GD003', tai_san_id: 'TS003', ten_tai_san: 'Đất nền Nhà Bè 120m²',
    nguoi_ban_id: 'U06', ten_nguoi_ban: 'Vũ Thanh Hà',
    nguoi_mua_id: 'U07', ten_nguoi_mua: 'Đinh Văn Dũng',
    doi_tac_id: 'U03', ten_doi_tac: 'Nguyễn Minh Tuấn',
    gia_giao_dich: 2100000000, ngay_tao: '2026-02-20', ngay_cap_nhat: '2026-04-10',
    trang_thai: 'hoan_thanh',
  },
  {
    id: 'GD004', tai_san_id: 'TS004', ten_tai_san: 'Biệt thự Thảo Điền 350m²',
    nguoi_ban_id: 'U08', ten_nguoi_ban: 'Ngô Thị Mai',
    nguoi_mua_id: 'U09', ten_nguoi_mua: 'Bùi Anh Khoa',
    doi_tac_id: 'U03', ten_doi_tac: 'Nguyễn Minh Tuấn',
    gia_giao_dich: 18500000000, ngay_tao: '2026-04-20', ngay_cap_nhat: '2026-04-29',
    trang_thai: 'tiem_nang',
  },
  {
    id: 'GD005', tai_san_id: 'TS005', ten_tai_san: 'Căn hộ Masteri Thảo Điền',
    nguoi_ban_id: 'U10', ten_nguoi_ban: 'Lý Thị Thu',
    nguoi_mua_id: 'U11', ten_nguoi_mua: 'Trương Minh Phúc',
    doi_tac_id: 'U03', ten_doi_tac: 'Nguyễn Minh Tuấn',
    gia_giao_dich: 4500000000, ngay_tao: '2026-04-05', ngay_cap_nhat: '2026-04-25',
...
export default function DoiTacDashboard() {
  ...
  const hoaHongThang = mockHoaHong.filter(h => !h.da_thanh_toan).reduce((s, h) => s + h.so_tien, 0)
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 space-y-6">
        ...
        <AlertBanner
          type="warning"
          title="Nhắc nhở: 2 giao dịch cần hành động"
          message="GD001 chờ ký hợp đồng — hạn ngày 05/05. GD005 chờ thanh toán — hạn ngày 08/05."
        />

        {/* Metrics */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <MetricCard title="Đang xử lý" value={`${dangXuLy} GD`} sub="Cần theo dõi" icon="📋" color="blue" />
          <MetricCard title="Hoa hồng chờ nhận" value={formatVND(hoaHongThang)} sub="Dự kiến tháng 5" icon="💰" color="green" />
                    ...
                    return (
                      <tr key={gd.id} className="hover:bg-gray-50 transition-colors">
                        <td className="px-5 py-3">
                          <p className="font-medium text-gray-900 truncate max-w-[200px]">{gd.ten_tai_san}</p>
                        ...
                        <td className="px-5 py-3 text-center">
                          <Badge label={ts.label} variant={ts.variant} />
                        </td>
                      </tr>
                    )
                  })}
